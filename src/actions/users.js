...
// Action Creators
const userClearList = () => ({ type: 'USER_CLEAR_LIST' });
const userLookupFailure = error => ({ type: 'USER_LOOKUP_FAILURE', error });
const userLookupSuccess = json => ({ type: 'USER_LOOKUP_SUCCESS', json });
